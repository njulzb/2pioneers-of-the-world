...
public class kday_upGraphic extends Pane {


    public kday_upGraphic me = this;


    private static double prefW = 600, prefH = 350;
    ...
    public kday_upGraphic(StockVO vo, LeftMessagePane leftPane) {
        if (vo != null) {
