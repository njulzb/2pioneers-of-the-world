...
public class kday_volumeItem extends Pane {
    private kday_volumeItem me = this;
    ...
    public kday_volumeItem(StockItem vo, double scale, double prefH, double prefW, double formHead_low) {
        if (vo != null) {
            high = vo.getHigh();
            low = vo.getLow();
            open = vo.getOpen();
